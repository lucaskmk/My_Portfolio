      ...
      >
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '55%', overflow: 'hidden' }}>
          <svg
            ...
            style={{ position: 'absolute', bottom: 0, left: 0, width: '200%', height: '100%', animation: 'ws3 9s linear infinite' }}
          >
            <path
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '40%', overflow: 'hidden' }}>
          <svg
            viewBox="0 0 2880 160"
            preserveAspectRatio="none"
            style={{ position: 'absolute', bottom: 0, left: 0, width: '200%', height: '100%', animation: 'ws1 6s linear infinite' }}
          >
            <path
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '28%', overflow: 'hidden' }}>
          <svg
            viewBox="0 0 2880 160"
            preserveAspectRatio="none"
            style={{ position: 'absolute', bottom: 0, left: 0, width: '200%', height: '100%', animation: 'ws2 4s linear infinite' }}
          >
            <path
